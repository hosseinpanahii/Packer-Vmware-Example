...
#mkpasswd -m sha-512 --rounds=4096:wq
...
#sed -i "s/^    - name:.*/    - name: $username/" subiquity/http/user-data
# created by MSH
sed -i "s|^    username:.*|    username: $username|" subiquity/http/user-data
...
#sed -i "s|^    password:.*|    password: $rawpassword|" subiquity/http/user-data
#sed -i "s|^      passwd:.*|      passwd: $password|" subiquity/http/user-data
# Created by MSH.
